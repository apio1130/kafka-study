...
import com.fastcampus.chap3clip3.consumer.listener.DefaultMessageListener;
...
public class MessageListenerContainerConfiguration {
    ...
    public KafkaMessageListenerContainer<String, String> kafkaMessageListenerContainer() {
        ContainerProperties containerProps = new ContainerProperties("clip3");
        containerProps.setGroupId("clip3-container");
